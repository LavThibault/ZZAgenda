...
?>
    ...
    <div class="container">
           ...
           <fieldset>
             ...
             <!-- Form Name -->
             <legend><center>Modify a conference</center></legend>
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                  <button id="submit" name="submit" type="submit" class="btn btn-primary">Modify</button>
                </div></center>
              </div>
          ...
          if(isset($_POST['submit'])){
            if(checkdate(substr($_POST['date'], 3, 2),substr($_POST['date'], 0, 2),substr($_POST['date'], 6, 4))){
              ...
              <script>alert("Enter a valid date");</script>
